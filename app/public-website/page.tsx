...
const translations = {
  en: {
    ...
    alt: "School logo",
    welcome: "Welcome to connected AI",
    description:
      "A renewed school assistant for students, families, teachers, administration, and guests.",
    supporting:
    ...
    roles: [
      ...
      },
      {
        title: "Registration",
        description:
          "Find the official document checklists for new and returning students.",
        href: "/registration",
      },
      {
  ...
  fr: {
    ...
    schoolName: SCHOOL_NAME,
    alt: "Logo de l'école",
    welcome: "Bienvenue sur connected AI",
    description:
      "Assistant IA renouvele pour les eleves, les familles, les enseignants, l'administration et les visiteurs.",
    supporting:
    ...
    roles: [
      ...
      },
      {
        title: "Inscriptions",
        description:
          "Retrouvez les listes officielles de documents pour les nouveaux eleves et les renouvellements.",
        href: "/registration",
      },
      {
  ...
  ar: {
    ...
    schoolName: SCHOOL_NAME,
    alt: "شعار المدرسة",
    welcome: "مرحبًا بكم في connected AI",
    description:
      "مساعد مدرسي متجدد للطلاب والعائلات والمعلمين والإدارة والزوار.",
    supporting:
    ...
    roles: [
      ...
      },
      {
        title: "التسجيل",
        description:
          "اطّلع على لوائح المستندات الرسمية للتلاميذ الجدد ولتجديد التسجيل.",
        href: "/registration",
      },
      {
...
export default function HomePage({ searchParams }: HomePageProps) {
  ...
  const roleCards = t.roles.toSorted(
    (a, b) =>
    ...
    <main className="gem-page text-slate-950" dir={textDirection}>
      <div className="relative z-10 mx-auto max-w-7xl px-5 py-5 sm:px-8 sm:py-7">
        <nav className="gem-panel sticky top-4 z-30 flex items-center justify-between gap-4 rounded-3xl px-4 py-3 sm:px-5">
          <Link
            href={{ pathname: "/public-website", query: { lang: language } }}
          ...
          <section className="relative px-6 py-12 sm:px-10 sm:py-16 lg:px-14 lg:py-20">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <div className="gem-fade-up gem-delay-3 mt-8 flex flex-wrap justify-center gap-3">
                ...
                >
                  {language === "fr" ? "Explorer connected AI" : language === "ar" ? "استكشف connected AI" : "Explore connected AI"}
                </a>
                <a
                  href="#contact"
